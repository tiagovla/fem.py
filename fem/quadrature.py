...
Quadrature = namedtuple('Quadrature', ['p', 'w'])
"""Represent a Quadrature namedtuple."""

def get_quadrature(refdom: Type[Refdom],
                   norder: int) -> Quadrature:
    ...
    """
    if refdom == RefTri:
        Y, W = get_quadrature_tri(norder)
    elif refdom == RefTet:
        Y, W =  get_quadrature_tet(norder)
    elif refdom == RefLine:
        Y, W = get_quadrature_line(norder)
    elif refdom == RefPoint:
        Y, W =  get_quadrature_point(norder)
    elif refdom == RefQuad:
